...
A visual organization chart has been introduced, providing a clear hierarchy view of the entire company structure for better organizational transparency. 
It helps users easily understand reporting relationships, team hierarchies, and overall organizational layout. 

**How to Access**

- Log in to the HRMS Dashboard  

- Navigate to the Company tab  

- Click on Organization Chart  

- Click on the Expand icon to view the chart in full screen 
